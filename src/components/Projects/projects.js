            ...
            <div className="projectsContent">
                ...
                <div className="projectsContent">
                        <ul className="projectDescription">
                            ...
                            <li className="listItem">Deployed the site using GitHub pages, integrating responsive design for optimal performance across devices</li>
                        </ul>
                </div>
                ...
                <div className="projectsContent">
                        <ul className="projectDescription">
                            ...
                            <li className="listItem">Automated data ingestion and analysis pipleines to reduce manual processing time by over 80%</li>
                ...
                <div className="projectsContent">
                        <ul className="projectDescription">
                            ...
                            <li className="listItem">Implemneted clustering techniques to group current players to past players, adjusting for age-related performance changes, resulting in more accurate predictions for players in their prime vs. older players</li>
                ...
                <div className="projectsContent">
                        <ul className="projectDescription">
                            ...
                            <li className="listItem">Applied concepts, such as linear regression, logisitc regression, and random forest models for feature importance analysis and improving model accuracy through ensemble learning</li>
                        </ul>
                </div>
                ...
                <span className="projectsName">C++ Ultrasound Data Calculations  <a
                ...
                <span className="projectsName">Re-creation of Pacman Using Java  <a
