        ...
        <section id="experience">
            <div className="experienceContent">
                ...
                <div className="work">
                    ...
                    <div className="workContent">
                        <ul className="jobDescription">
                            ...
                            <li className="listItem">Technical Skills Used: Python, R Programming, Power BI, Git, GitHub, Jupyer Notebooks, Data Analysis, Data Science, Excel</li>
                        </ul>
                ...
                <div className="volunteer">
                    ...
                    <p className="volunteerName">Camp Counselor - Camp Tamarck and Victoria Park Collegiate Institute</p>
                    <div className="volunteerContent">
                        <ul className="volunteerDescription">
