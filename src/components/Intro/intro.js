    ...
    return (
        <section id="home">
            <div className="introContent">
                ...
                <p className="introText">My name is Justin Mende. I am currently a third-year Biomedical Engineering student-athlete at the University of Waterloo. Welcome to my personal portfolio website.
